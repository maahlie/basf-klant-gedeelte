...
<head>
  ...
  <link rel="icon" href="images/nunhems-icon.png">
  ...
  <div class="grid">
    ...
    <form action="php/login.php" method="POST" class="form login">
      ...
      if (isset($_SESSION['error']))
      {
        if ($_SESSION['error'] != "0" )
        {
          echo '<div id="employeelogin_wronginfo" class="errorstyle errorbox">
      ...
      <div class="form__field">
        ...
        <input autocomplete="off" id="login__username" type="email" name="email" class="form__input" placeholder="Email" required>
      </div>
