...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2021 at 01:34 PM
...
CREATE TABLE `werknemer` (
  ...
  `werknemer_rol` enum('werknemer','teamleider','planner','klant') NOT NULL,
...
--
ALTER TABLE `werknemer`
  MODIFY `werknemer_id` int(3) NOT NULL AUTO_INCREMENT;
COMMIT;
